              ...
              <div className="d-flex justify-content-between h-100">
                <div className="bor_right pl-70 paddingtop55">
                  ...
                  <ul className="f_link pb-0">
                    ...
                    <li><Link to="/fair-play">Fair Play</Link></li>
                    <li><Link to="/legalities">Legalities</Link></li>
                ...
                <div className="bor_right pl-70 paddingtop55">
                  ...
                  <ul className="f_link pb-0">
                    ...
                    <li><Link to="/point-system">Fantasy Point System</Link></li>
                    <li><Link to="/terms">Terms &amp; Conditions</Link></li>
                    <li><Link to="/how-to-play">How to Play</Link></li>
                    <li><Link to="/withdrawal">Withdraw Policy</Link></li>
                  </ul>
                </div>
